...
class AuthorizeKommo
{
    ...
    public function authorize()
    {
        ...
        try {
            ...
            $result = (new GetAllKommoUsers($apiClient))->getUsers();
        ...
        $importedContacts = ((new ImportContactsToUnisender())->getterContact($result));

        return json_decode($importedContacts);
    }
}
